...
float_x grid_cpu_tri::bbmin_x() const {
	return m_bbmin_x;
}

float_x grid_cpu_tri::bbmin_y() const {
	return m_bbmin_y;
}

float_x grid_cpu_tri::bbmin_z() const {
	return m_bbmin_z;
}

float_x grid_cpu_tri::dx() const {
	return m_dx;
}

void grid_cpu_tri::update_geometry_mesh(std::vector<mesh_triangle> tris, float_x h_avg) {
