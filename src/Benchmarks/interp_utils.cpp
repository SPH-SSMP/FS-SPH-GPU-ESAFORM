...
static float4_t cubic_spline(float4_t posi, float4_t posj, float_x hi) {
...
void interp_temps(const std::vector<float4_t> &vals_in, float_x weights, float_x h, std::vector<float4_t> &vals_out) {
