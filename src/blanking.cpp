...
blanking::blanking(float_x max_vel) :
		m_max_vel_squared(max_vel) {}

blanking::blanking(vec3_t bbmin, vec3_t bbmax, float_x max_vel) :
		m_bbmin(bbmin), m_bbmax(bbmax), m_bbmin_init(bbmin), m_bbmax_init(bbmax), m_max_vel_squared(max_vel*max_vel) {}

blanking::blanking(vec3_t bbmin, vec3_t bbmax, vec3_t bbvel, float_x max_vel) :
...
float_x blanking::get_max_vel_squared() const {
