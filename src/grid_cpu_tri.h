...
class grid_cpu_tri {
public:
	void update_geometry_mesh(std::vector<mesh_triangle> tris, float_x h_avg);
...
private:
	...
	float_x m_dx;
	float_x m_lx, m_ly, m_lz;
	unsigned int m_nx, m_ny, m_nz;
	unsigned int m_num_cell;

	float_x m_bbmin_x, m_bbmax_x;
	float_x m_bbmin_y, m_bbmax_y;
	float_x m_bbmin_z, m_bbmax_z;
};
